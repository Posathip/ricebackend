/*
  ...
  - Changed the type of `jobID` on the `certificatesheet` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
-- AlterTable
ALTER TABLE "certificatesheet" DROP COLUMN "jobID",
