/*
  ...
  - You are about to drop the column `portName` on the `Description` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Description" DROP COLUMN "portName",
...
-- AlterTable
ALTER TABLE "Request" ADD COLUMN     "portName" TEXT,
ALTER COLUMN "createdAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now()),
ALTER COLUMN "updatedAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now());
