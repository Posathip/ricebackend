...
-- AlterTable
ALTER TABLE "surveyName" ADD COLUMN     "goDownGroupID" TEXT,
...
-- CreateTable
CREATE TABLE "goDownGroup" (
    "goDownGroupID" TEXT NOT NULL,
    "goDownGroupName" TEXT,
    "goDownColor" TEXT,
    ...
    CONSTRAINT "goDownGroup_pkey" PRIMARY KEY ("goDownGroupID")
);

-- AddForeignKey
ALTER TABLE "surveyName" ADD CONSTRAINT "surveyName_goDownGroupID_fkey" FOREIGN KEY ("goDownGroupID") REFERENCES "goDownGroup"("goDownGroupID") ON DELETE SET NULL ON UPDATE CASCADE;
