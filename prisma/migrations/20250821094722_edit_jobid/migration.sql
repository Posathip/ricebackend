/*
  ...
  - The `jobID` column on the `validate_Check_Weight` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
-- AlterTable
ALTER TABLE "validate_Check_Weight" DROP COLUMN "jobID",
