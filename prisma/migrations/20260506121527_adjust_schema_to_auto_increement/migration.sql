/*
  ...
  - Made the column `staffNo` on table `staff` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
CREATE SEQUENCE staff_staffno_seq;
ALTER TABLE "staff" ALTER COLUMN "createdAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now()),
ALTER COLUMN "updatedAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now()),
ALTER COLUMN "staffNo" SET NOT NULL,
ALTER COLUMN "staffNo" SET DEFAULT nextval('staff_staffno_seq');
ALTER SEQUENCE staff_staffno_seq OWNED BY "staff"."staffNo";
