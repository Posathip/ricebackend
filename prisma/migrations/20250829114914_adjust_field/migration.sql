/*
  ...
  - You are about to drop the column `allWage` on the `validate_Check_Weight` table. All the data in the column will be lost.
  - You are about to drop the column `wage` on the `validate_Check_Weight` table. All the data in the column will be lost.
  - You are about to drop the column `wageVehicle` on the `validate_Check_Weight` table. All the data in the column will be lost.
  - You are about to drop the column `wegeOverTime` on the `validate_Check_Weight` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "validate_Check_Weight" DROP COLUMN "allWage",
DROP COLUMN "wage",
DROP COLUMN "wageVehicle",
DROP COLUMN "wegeOverTime",
