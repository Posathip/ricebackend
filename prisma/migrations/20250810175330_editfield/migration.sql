/*
  ...
  - The `numberSample` column on the `extraInvoice` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
-- AlterTable
ALTER TABLE "extraInvoice" DROP COLUMN "numberSample",
ADD COLUMN     "numberSample" DOUBLE PRECISION,
