...
-- CreateTable
CREATE TABLE "entireCertificate" (
    "entireCertificateID" TEXT NOT NULL,
    "orderbillNo" INTEGER,
    ...
    "statusAccounting" BOOLEAN NOT NULL,
    ...
    CONSTRAINT "entireCertificate_pkey" PRIMARY KEY ("entireCertificateID")
);
