...
-- AlterTable
ALTER TABLE "validate_Check_Weight" ADD COLUMN     "allWage" DOUBLE PRECISION,
ADD COLUMN     "wage" DOUBLE PRECISION,
ADD COLUMN     "wageVehicle" DOUBLE PRECISION,
ADD COLUMN     "wegeOverTime" DOUBLE PRECISION,
