/*
  ...
  - You are about to drop the column `vesselName` on the `validate_Check_Weight` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "certificatesheet" ADD COLUMN     "packingLine1" TEXT,
ADD COLUMN     "packingLine2" TEXT,
ADD COLUMN     "packingLine3" TEXT,
...
-- AlterTable
ALTER TABLE "validate_Check_Weight" DROP COLUMN "vesselName",
ALTER COLUMN "createdAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now()),
ALTER COLUMN "updatedAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now());
