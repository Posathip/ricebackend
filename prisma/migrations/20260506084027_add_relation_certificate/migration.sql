/*
  ...
  - A unique constraint covering the columns `[checkWeightID]` on the table `certificatesheet` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "certificatesheet" ADD COLUMN     "checkWeightID" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "certificatesheet_checkWeightID_key" ON "certificatesheet"("checkWeightID");

-- AddForeignKey
ALTER TABLE "certificatesheet" ADD CONSTRAINT "certificatesheet_checkWeightID_fkey" FOREIGN KEY ("checkWeightID") REFERENCES "validate_Check_Weight"("checkWeightID") ON DELETE SET NULL ON UPDATE CASCADE;
