/*
  ...
  - You are about to drop the column `statusContinue` on the `NotificationReceipt` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "NotificationReceipt" DROP COLUMN "statusContinue",
