/*
  ...
  - You are about to drop the column `remainNetWeightKG` on the `Description` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Description" DROP COLUMN "remainNetWeightKG",
ADD COLUMN     "remainNetWeightKGM" DOUBLE PRECISION,
