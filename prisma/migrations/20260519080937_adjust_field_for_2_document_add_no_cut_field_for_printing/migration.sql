...
-- AlterTable
ALTER TABLE "DataFromGoverment" ADD COLUMN     "exportAgentNoCut" TEXT,
ADD COLUMN     "exporterNoCut" TEXT,
...
-- AlterTable
ALTER TABLE "LicenseDetail" ADD COLUMN     "productDescriptionNotCut" TEXT,
ALTER COLUMN "createdAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now()),
ALTER COLUMN "updatedAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now());
