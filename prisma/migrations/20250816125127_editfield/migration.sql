-- DropForeignKey
ALTER TABLE "Description" DROP CONSTRAINT "Description_requestId_fkey";
...
-- AddForeignKey
ALTER TABLE "Description" ADD CONSTRAINT "Description_requestId_fkey" FOREIGN KEY ("requestId") REFERENCES "Request"("requestID") ON DELETE CASCADE ON UPDATE CASCADE;
