/*
  ...
  - You are about to drop the column `companyName` on the `validate_Check_Weight` table. All the data in the column will be lost.
  - You are about to drop the column `riceTypeID` on the `validate_Check_Weight` table. All the data in the column will be lost.
  - You are about to drop the column `shippingDate` on the `validate_Check_Weight` table. All the data in the column will be lost.
  - You are about to drop the column `statusContinue` on the `validate_Check_Weight` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "validate_Check_Weight" DROP COLUMN "companyName",
DROP COLUMN "riceTypeID",
DROP COLUMN "shippingDate",
DROP COLUMN "statusContinue",
