/*
  ...
  - You are about to drop the column `more` on the `validate_Check_Weight` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "validate_Check_Weight" DROP COLUMN "more",
