...
-- CreateTable
CREATE TABLE "surveyName" (
    "surveyNameID" TEXT NOT NULL,
    "amphoes" TEXT NOT NULL,
    "changwat" TEXT NOT NULL,
    "surveyNameEN" TEXT NOT NULL,
    "surveyNameTH" TEXT NOT NULL,
    ...
    CONSTRAINT "surveyName_pkey" PRIMARY KEY ("surveyNameID")
);
