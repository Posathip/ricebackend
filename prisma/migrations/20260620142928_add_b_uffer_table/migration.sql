-- AlterTable
ALTER TABLE "BufferRemain" ALTER COLUMN "createdAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now()),
...
-- AlterTable
ALTER TABLE "entireCertificate" ALTER COLUMN "createdAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now()),
ALTER COLUMN "updatedAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now());
...
-- AlterTable
ALTER TABLE "goDownGroup" ALTER COLUMN "createdAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now()),
ALTER COLUMN "updatedAt" SET DEFAULT timezone('Asia/Ho_Chi_Minh', now());
...
CREATE TABLE "NotificationReceipt" (
    "notificationReceiptID" TEXT NOT NULL,
    "jobName" TEXT,
    "checkWeightID" TEXT,
    ...
    CONSTRAINT "NotificationReceipt_pkey" PRIMARY KEY ("notificationReceiptID")
);

-- CreateIndex
CREATE UNIQUE INDEX "NotificationReceipt_checkWeightID_key" ON "NotificationReceipt"("checkWeightID");

-- AddForeignKey
ALTER TABLE "NotificationReceipt" ADD CONSTRAINT "NotificationReceipt_checkWeightID_fkey" FOREIGN KEY ("checkWeightID") REFERENCES "validate_Check_Weight"("checkWeightID") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "NotificationReceipt" ADD CONSTRAINT "NotificationReceipt_requestID_fkey" FOREIGN KEY ("requestID") REFERENCES "Request"("requestID") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "NotificationReceipt" ADD CONSTRAINT "NotificationReceipt_descriptionID_fkey" FOREIGN KEY ("descriptionID") REFERENCES "Description"("descriptionID") ON DELETE RESTRICT ON UPDATE CASCADE;
