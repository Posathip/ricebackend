/*
  ...
  - You are about to drop the column `appliedGodown` on the `certificatesheet` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "certificatesheet" DROP COLUMN "appliedGodown",
ADD COLUMN     "applyGodown" BOOLEAN,
