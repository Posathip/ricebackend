...
-- CreateTable
CREATE TABLE "cerfificateDetail" (
    "certificateDetailID" TEXT NOT NULL,
    ...
    CONSTRAINT "cerfificateDetail_pkey" PRIMARY KEY ("certificateDetailID")
);
...
CREATE TABLE "packing" (
    ...
    CONSTRAINT "packing_pkey" PRIMARY KEY ("packingID")
);
